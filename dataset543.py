...
if __name__ == "__main__":
    ...
    train_pos, train_neg = gen_PDNA543_HHM(train_hhm, train_sites,'PDNA543_HHM_11.npz',11)
    test_pos, test_neg = gen_PDNA543_HHM(test_hhm, test_sites, 'PDNA543TEST_HHM_11.npz',11)
